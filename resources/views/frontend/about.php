                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <p class="feature-card-desc">
                                <p>Innovative Leisure is a leading turnkey solutions provider for the leisure and entertainment industry,
                                   creating spaces that inspire play, adventure, and connection. We specialize in designing, building,
                                    and operating immersive entertainment environments for all ages, from children’s soft play zones to
                                     full-fledged family entertainment centers (FECs), and from adventure play areas to complete adventure
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6 col-content">
                    <div class="about-heading heading">
                        ...
                        <p class="heading--desc color-white">Our team combines creative vision, technical expertise, and operational insight to bring ideas to life. We provide end-to-end solutions covering:</p>
                        
                      </div>
                      <div class="about-expetise">
                          <ul>
                            <li><b>Concept Development & Design </b> – Custom themes, layouts, and guest experiences</li>
                      ...
                      <p class="color-white">We have extensive experience across <b>soft play zones, trampoline parks, climbing walls, ziplines, adventure play areas,
                         social entertainment venues, family entertainment centers (FECs)</b>, and <b>interactive attractions <b>. Every project is crafted to deliver
                          <b>immersive experiences that attract visitors, boost engagement, and maximize returns</b></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <p class="feature-card-desc">
                                 ...
                                 Our projects combine safety, creativity, and operational excellence, providing memorable experiences,
                                  smooth operations, and long-term value. We don’t just build attractions, we create destinations that
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="400ms">
                 ...
                 <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                         <a href="{{ url('services') }}" class="btn btn--primary btn-padding btn--bordered btn--rounded">Explore Our Services </a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <p class="feature-card-desc">
                               <p>At <b>Innovative Leisure</b>, our vision is to be the <b>most trusted and innovative partner</b> for the leisure and
                                 entertainment industry. We are committed to delivering <b>turnkey solutions that combine creativity, safety, 
                                 and profitability</b>, ensuring every project becomes a <b>memorable destination that engages guests and drives
