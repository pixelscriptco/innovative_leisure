                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <p>We provide <b>turnkey solutions for the leisure and entertainment industry</b>, creating
                                spaces that inspire play, adventure, and connection</p>
                            ...
                            <p><b>Family Entertainment Centers (FECs)</b> – Complete destinations combining play,
                                learning, and excitement.</p>
                            <p><b>Interactive Experiences </b> – Engaging tech-driven activities that keep guests coming
                                back. </p>
                            <p><b>Social Entertainment Venues</b> – Innovative concepts for dining, games, and
                                gatherings.</p>
                            <p><b>Restaurants & Cafes</b> – Curated dining experiences to complement entertainment
                                destinations.</p>

                            <p>From <b>concept design to installation and ongoing support</b>, we handle every detail
                                ensuring safety, creativity, and long-term performance</p>
            ...
            <div class="row clearfix">
                <div class="col-sm-12 col-md-12 col-lg-6 offset-md-3">
                    <div class="heading heading-1 text--center mb-40">
                        <h2 class="heading--title text-white">Our Business Models</h2>
                        <p class="heading--desc heading--light mb-0 color-white">
                            Explore our turnkey business models designed for sustainable growth, consistent return, and
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 price-table">
                    <div class="pricing-panel">
                        ...
                        <div class="pricing--heading text--center">
                            ...
                            <p><span class="currency f-size-20">AED</span><span class="f-size-40"> 1.25M</span></p>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 price-table ">
                    <div class="pricing-panel">
                        ...
                        <div class="pricing--heading text--center">
                            ...
                            <p><span class="currency f-size-20">AED</span><span class="f-size-40"> 1.8M</span></p>
                            <div class="pricing--desc">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 price-table">
                    <div class="pricing-panel">
                        ...
                        <div class="pricing--heading text--center">
                            ...
                            <p><span class="currency f-size-20">AED</span><span class="f-size-40"> 250,000</span></p>
                            <div class="pricing--desc">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <p class="feature-card-desc">
                            <p><b>Innovative Leisure is a specialist leisure development company</b> dedicated to
                                building <b>immersive, profitable, and future-ready entertainment spaces.</b><br>
                                We combine <b>creative design, engineering expertise</b>, and <b>operational insight</b>
                                to bring ideas to life from <b>soft play centers and trampolines</b> to <b>adventure
                                    parks and social entertainment hubs.</b></p>
