    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-4 col-lg-4 price-table">
        <div class="pricing-panel">
            <div class="pricing--icon mb-3">
              <img src="assets/images/about/about.png" alt="Starter Plan Icon" class="img-fluid w-100 rounded-3">
            </div>
      ...
      <div class="col-sm-12 col-md-4 col-lg-4 price-table pricing-active">
        <div class="pricing-panel">
          <div class="pricing--heading text--center">
            <div class="pricing--icon mb-3">
              <img src="assets/images/icons/basic.png" alt="Basic Plan Icon" class="img-fluid w-100 rounded-3">
            </div>
            <h4>Basic Plan</h4>
      ...
      <div class="col-sm-12 col-md-4 col-lg-4 price-table">
        <div class="pricing-panel">
          <div class="pricing--heading text--center">
            <div class="pricing--icon mb-3">
              <img src="assets/images/icons/advanced.png" alt="Advanced Plan Icon" class="img-fluid w-100 rounded-3">
            </div>
            <h4>Advanced Plan</h4>
